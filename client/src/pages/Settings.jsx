             ...
             <Card title="Préférences Générales">
                <form className="space-y-4">
                    <div>
                        ...
                        <select className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-[#D2D4D6] dark:border-[#262626] bg-[#F5F5F7] dark:bg-[#121212] text-[#1A1A1A] dark:text-[#F5F5F5] focus:outline-none focus:border-[#1A1A1A] dark:focus:border-[#F5F5F5] sm:text-sm rounded-md border transition-colors duration-150">
                            <option>EUR (€)</option>
                            <option>USD ($)</option>
                        </select>
                    </div>
